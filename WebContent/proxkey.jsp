...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <div class="tab-content">
        <div class="content three_quarter first tab-pane fade in active" id="features"> 
          <!-- ################################################################################################ -->
          ...
          <h2>FEATURES</h2>
            <ul >
                ...
                <li>	 Password Caching</li>
                <li>	 Inbuilt Remote Assistance Software</li>
                <li>	 Inbuilt Diagnostic Tool</li>
                <li>	 SoftKey Keyboard for Password Security</li>
                <li>	 Ticket Support Panel</li>
                <li>	 Print Certificate Credentials</li>
                <li>	 One Click System Settings for PKI Apps</li>
                <li>	 One Click Java Configuration</li>
                <li>	 Inbuilt PDF, Office & File Signer</li>
                <li>	 Multi Operating System Support</li>
                <li>	 Plug & Play Device</li>
                <li>	 Easy Driver Installation</li>
                <li>	 Simplest User Interface</li>
                <li>	 In Built Root Certificate</li>
                <li>	 Certificate Expiry Notification</li>
                </ul>
        ...
        <div class="content three_quarter first tab-pane fade" id="specifications"> 
          <!-- ################################################################################################ -->
      ...
      <nav class="sdb_holder">
        <ul class="nav nav-tabs">
          <li class="active"><a data-toggle="tab" href="#features">Features</a></li>
            <li><a data-toggle="tab" href="#specifications"> Technical Specifications</a></li>
